...
def track_page_visit(did, name, view, is_service , activtiy= False, additional_field = ''):
    try:
        track_obj = TrackUserPageVisits.objects.get(did=did, name=name, view=view, is_service=is_service , activity_completed=activtiy , additional_field=additional_field)
        track_obj.name = name
        track_obj.view = view
